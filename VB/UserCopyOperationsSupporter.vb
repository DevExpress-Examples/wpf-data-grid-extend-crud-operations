...
Namespace UndoOperation
    ...
    Public Class UserCopyOperationsSupporter
        Implements UndoOperation.IDataItemCopyOperationsSupporter

        Public Function Clone(ByVal item As Object) As Object Implements Global.UndoOperation.IDataItemCopyOperationsSupporter.Clone
        ...
        Public Sub CopyTo(ByVal source As Object, ByVal target As Object) Implements Global.UndoOperation.IDataItemCopyOperationsSupporter.CopyTo
