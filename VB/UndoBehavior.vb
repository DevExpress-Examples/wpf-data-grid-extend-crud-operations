...
Namespace UndoOperation
    ...
    Public Class UndoBehavior
        ...
        Shared Sub New()
            CopyOperationsSupporterProperty = DependencyProperty.Register(NameOf(UndoBehavior.CopyOperationsSupporter), GetType(IDataItemCopyOperationsSupporter), GetType(UndoBehavior), New PropertyMetadata(CType(Nothing, PropertyChangedCallback)))
        End Sub
        ...
        Public Property CopyOperationsSupporter As IDataItemCopyOperationsSupporter
            Get
                Return CType(GetValue(CopyOperationsSupporterProperty), IDataItemCopyOperationsSupporter)
            End Get

            Set(ByVal value As IDataItemCopyOperationsSupporter)
